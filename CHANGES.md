...
This document tracks all notable changes to PhotoClove during development.
Version numbers will be assigned at the first official release.

## 2026-02-07 - S3 Enhanced Support & UI Improvements

### S3 Cloud Backup Enhancements
...
## 2026-02-03 - Search Functionality & Display Window Algorithm
...
## 2025-07-26 - EXIF Data, Google Photos & Job Queue
...
- **Migration Required**: Users must migrate to SQLite before upgrading
...
## 2025-07-20 - UUID-Based Import Directory Structure
...
## 2025-01-31 - Database Cleanup & SQLite Improvements
...
## 2025-01-14 - CSS-Based Image Editor & UI Layout
...
- **Animated Scroll Indicators**: Replaced image-based scroll indicators with animated text
- **Fixed Scroll Behavior**: Enhanced scroll limits to prevent scrolling beyond load indicators
...
## 2025-01-13 - Photo Display & Import Improvements
...
- **TSV Users**: Must migrate to SQLite (TSV support was removed in 2025-07-26 update)
...
### Breaking Changes
- **2025-07-26**: TSV support completely removed
- **2025-07-26**: Import API changed to return job IDs instead of blocking
- **2025-01-13**: Migration from TSV to SQLite required for optimal performance
