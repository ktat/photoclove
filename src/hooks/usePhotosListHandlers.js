...
export function usePhotosListHandlers({
    ...
    return useMemo(() => ({
        ...
        handlePersonClick, handlePersonSelection, clearPersonSelection, deleteSelectedPersons, handleUnknownFaceSelection, clearUnknownFaceSelection, setFaceSearchTerm, setFaceViewType, openFacesList, reloadFaces,
