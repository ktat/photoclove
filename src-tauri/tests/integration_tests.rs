...
mod tests {
    ...
    fn test_json_serialization() {
        ...
        let parsed_data: serde_json::Value = serde_json::from_str(&json_str).expect("Failed to parse JSON");
    ...
    fn test_path_operations() {
        ...
        assert_eq!(photo_path.file_name().unwrap().to_string_lossy(), "photo.jpg");
