...
/// Search filter criteria for querying photos.
///
/// Supports filtering by camera, lens, ISO, aperture, focal length,
/// date range, comments, star ratings, file extensions, and tags.
...
pub struct SearchFilters {
    ...
    /// Filter by ISO range (min, max)
    pub iso_range: Option<(u32, u32)>,

    /// Filter by aperture range (min, max)
    pub aperture_range: Option<(f32, f32)>,

    /// Filter by focal length range (min, max)
    pub focal_length_range: Option<(f32, f32)>,

    /// Filter by date range (start, end)
    pub date_range: Option<(String, String)>,

    /// Filter to show only photos with comments
...
/// Information about a camera in the photo collection.
///
/// Used for displaying available cameras and their usage statistics.
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone)]
pub struct CameraInfo {
    ...
    /// Number of photos taken with this camera
    pub count: u32,
}

/// Information about a lens in the photo collection.
///
/// Used for displaying available lenses and their usage statistics.
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone)]
pub struct LensInfo {
    ...
    /// Number of photos taken with this lens
    pub count: u32,
}

/// Information about a file extension in the photo collection.
///
/// Used for displaying available file types and their counts.
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone)]
pub struct ExtensionInfo {
    /// File extension (e.g., "jpg", "png", "raw")
